...
export const mockTasks: Task[] = [
  {
    ...
    description: 'Design a modern authentication UI with email/password login, social OAuth buttons, and password reset flow. Follow Material Design principles.',
    status: 'todo',
    priority: 'high',
    assignedTo: 'agent-1',
    dependencies: [],
